...
```
git clone https://github.com/mrganesh665/Smartpost.git
...
```
VITE_SERVER_ENDPOINT = https://Smartpost-server.vercel.app:3000/api
VITE_TOKEN_KEY = Smart Post
VITE_USER_ROLE = role
